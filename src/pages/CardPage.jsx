      ...
      <div dir="rtl" style={{ background: 'linear-gradient(160deg,#eef6f7 0%,#f5fbfb 100%)', minHeight: '100vh' }}>
        ...
        <div className="fixed bottom-0 z-20"
          ...
          <div className="flex justify-center pb-2.5 pt-1.5">
            <a href="/" className="flex items-center gap-1.5 px-3 py-1 rounded-full transition-all hover:bg-gray-50">
              <div className="w-3.5 h-3.5 rounded flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #F4938C, #5BC4C8)' }}><LogoMark size={8} color="white" /></div>
              <span className="text-[10px] font-medium text-gray-400">נוצר עם <strong className="text-gray-600">Vizzit</strong></span>
            </a>
          </div>
        </div>
      </div>
