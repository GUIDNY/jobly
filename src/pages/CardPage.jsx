      ...
      <div className="relative md:min-h-screen md:flex md:flex-col md:items-center md:justify-center md:py-14 md:px-6">
        ...
        >
          ...
          {(card.instagram || card.facebook || card.tiktok || card.location_url) && (
            <div className="flex justify-center gap-3 mt-5 pb-1">
              {card.instagram && (
                <a href={`https://instagram.com/${card.instagram.replace('@','')}`} target="_blank" rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full flex items-center justify-center text-white shadow-md hover:scale-110 transition-transform"
              ...
              {card.location_url && (
                <a href={card.location_url} target="_blank" rel="noopener noreferrer"
                  ...
                  <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                </a>
              )}
            </div>
          )}
          ...
          {/* Vizzit CTA */}
          <div className="flex items-center justify-center mt-4 pb-20 md:pb-0">
            <a href="/"
