        ...
        <div className="flex-1 min-w-0 space-y-3 md:space-y-4">
          ...
          {storeType === 'single' && activeSection === 'payment' && (
            <motion.div key="payment" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-3">
              ...
              {/* WhatsApp — active */}
              <div className="bg-white rounded-2xl p-4 border border-gray-100 space-y-3" style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
              ...
              <div className="bg-white rounded-2xl p-4 border border-gray-100 space-y-3" style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.06)', opacity: 0.7 }}>
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="bg-white rounded-2xl p-4 border border-gray-100 space-y-3" style={{ boxShadow:'0 1px 4px rgba(0,0,0,0.06)' }}>
                    ...
                    <div className="relative">
                      ...
                      <input value={ms.social?.whatsapp || ''} onChange={e => updMultiSocial('whatsapp', e.target.value)}
                        placeholder="050-0000000" dir="ltr"
                        className="w-full border border-green-200 rounded-xl pr-12 pl-3 py-2.5 text-sm focus:outline-none focus:border-[#25D366] bg-green-50/30 transition-colors" />
                    </div>
                    <p className="text-xs text-gray-400">הלקוח לוחץ "הזמן בוואטסאפ" ונפתחת שיחה עם פרטי הסל</p>
                  </div>

                  {/* Credit card — coming soon */}
                  <div className="bg-white rounded-2xl p-4 border border-gray-100" style={{ boxShadow:'0 1px 4px rgba(0,0,0,0.06)', opacity:0.75 }}>
                    <div className="flex items-center gap-2.5 mb-3">
                      <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background:'#f3f4f6' }}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" strokeWidth="2"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
                      </div>
                      <div className="flex-1">
