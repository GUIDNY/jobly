            ...
            <motion.div className="w-full md:flex-1"
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <button onClick={() => navigate('/store-builder')}
                  className="flex items-center gap-2 px-6 py-3.5 rounded-xl text-sm font-semibold text-gray-600 border border-gray-200 hover:bg-gray-50 transition-colors">
                  בנה את החנות שלך
                  <span className="text-[10px] font-black px-1.5 py-0.5 rounded-full text-white" style={{ background: 'linear-gradient(135deg,#F4938C,#5BC4C8)' }}>בטא</span>
                </button>
              </div>
