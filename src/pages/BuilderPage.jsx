    ...
    <div dir="rtl" style={{ background: '#070910', minHeight: '100%', color: 'white', fontFamily: 'inherit', fontSize: 12, position: 'relative', overflow: 'hidden' }}>
      ...
      {(data.phone || data.location_url || data.booking_url) && (() => {
        ...
        const items = [
          ...
          data.phone && { label: 'WHATSAPP', color: '#22c55e', icon: (
          ...
          data.location_url && { label: 'LOCATION', color: '#4285F4', icon: (
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#4285F4" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
          )},
          data.booking_url && { label: 'BOOKING', color: accent, icon: (
      ...
      {/* Contact grid — below services */}
      {(data.contact_position || 'above') === 'below' && (data.phone || data.location_url || data.booking_url) && (() => {
        const items = [
